...
async function searchSpotifySpecificType(type, limit, offset, query, mainWindow) {
  ...
  variables = '{"searchTerm":"' + query + '","offset":' + offset + ',"limit":' + limit + ',"numberOfTopResults":20, "includeAudiobooks":false}'
...
async function getArtistInfo(artistID) {
  ...
  const hash = '{"persistedQuery": {"version": 1, "sha256Hash": "4313f019bcd5f69b6bc338d19e123a60fab1da35a89a4ed924d7903f2816d15c"}}'
...
async function getAlbumInfo(albumID) {
  ...
  const hash = '{"persistedQuery": {"version": 1, "sha256Hash": "3ea563e1d68f486d8df30f69de9dcedae74c77e684b889ba7408c589d30f7f2e"}}'
...
async function getAlbumMetadata(albumID) {
  ...
  const hash = '{"persistedQuery": {"version": 1, "sha256Hash": "411f31a2759bcb644bf85c58d2f227ca33a06d30fbb0b49d0f6f264fda05ecd8"}}'
...
async function getSongLyrics(id, coverImage) {
  ...
  referenceURL =
    "https://spclient.wg.spotify.com/color-lyrics/v2/track/4W4fNrZYkobj539TOWsLO2/image/https%3A%2F%2Fi.scdn.co%2Fimage%2Fab67616d0000b2738ad8f5243d6534e03b656c8b?format=json&vocalRemoval=false&market=from_token"
